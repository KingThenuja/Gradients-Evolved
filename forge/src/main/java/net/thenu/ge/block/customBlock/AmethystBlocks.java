...
public class AmethystBlocks {
    ...
    private static BlockFamilyBuilder builder(String name, BlockBehaviour.Properties props) {
        return new BlockFamilyBuilder(Constants.MOD_ID, new BlockFamilyDefinition(name, props), GEBlocks.BLOCKS, GEBlocks.ITEMS);
    }
    ...
    public static final RegistryObject<Block> CIRCULAR_AMETHYST_LAMP = registerLamp("circular_amethyst_lamp");
    public static final RegistryObject<Block> CROSSED_AMETHYST_LAMP  = registerLamp("crossed_amethyst_lamp");

    private static RegistryObject<Block> registerLamp(String name) {
        RegistryObject<Block> block = GEBlocks.BLOCKS.register(name, () ->
