...
public class NewMaterialsBlocks { public static void registerNewMaterialsBlock() {}
    ...
    public static final BlockFamily BLOCK_OF_RUBY = new BlockFamilyBuilder(Constants.MOD_ID, new BlockFamilyDefinition(
            "block_of_ruby", AbstractBlock.Settings.copy(Blocks.TUFF_BRICKS))).build();

    public static final BlockFamily BLOCK_OF_JADE = new BlockFamilyBuilder(Constants.MOD_ID, new BlockFamilyDefinition(
            "block_of_jade", AbstractBlock.Settings.copy(Blocks.TUFF_BRICKS))).build();

    public static final BlockFamily BLOCK_OF_SAPPHIRE = new BlockFamilyBuilder(Constants.MOD_ID, new BlockFamilyDefinition(
