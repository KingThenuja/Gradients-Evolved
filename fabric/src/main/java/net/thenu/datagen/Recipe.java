...
import static net.thenu.utils.DatagenHelper.RecipesForDatagen.*;
...
/*
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.SLIGHTLY_MOSSY_COBBLESTONE, net.minecraft.block.Blocks.COBBLESTONE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.OVERLY_MOSSY_COBBLESTONE, net.minecraft.block.Blocks.COBBLESTONE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.MOSSEND_COBBLESTONE, net.minecraft.block.Blocks.COBBLESTONE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.MOSSING_COBBLESTONE, net.minecraft.block.Blocks.COBBLESTONE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.FULLY_COVERED_MOSSY_COBBLESTONE, net.minecraft.block.Blocks.COBBLESTONE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.SLIGHTLY_MOSSY_DEEPSLATE, net.minecraft.block.Blocks.DEEPSLATE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.OVERLY_MOSSY_DEEPSLATE, net.minecraft.block.Blocks.DEEPSLATE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.MOSSEND_DEEPSLATE, net.minecraft.block.Blocks.DEEPSLATE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.MOSSY_DEEPSLATE, net.minecraft.block.Blocks.DEEPSLATE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.MOSSING_DEEPSLATE, net.minecraft.block.Blocks.DEEPSLATE, 1);
        ...
        offerStonecuttingRecipe(exporter, RecipeCategory.MISC, GEBlocks.FULLY_COVERED_MOSSY_DEEPSLATE, net.minecraft.block.Blocks.DEEPSLATE, 1);
